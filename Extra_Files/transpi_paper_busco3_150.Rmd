---
title: "transpi_paper_busco3_150"
...
```{r data, include=T}
csv=read.csv("busco3_150.csv", header=TRUE)
```
...
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "BUSCO genes (all sets)",
                  xaxis =list(categoryorder = "array", 
                  categoryarray = c("Complete", "Single-Copy", "Duplicated","Fragmented","Missing")),
                  yaxis=list(type = "linear", range=c(0,101), dtick=10))
p
```
...
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "Single-Copy BUSCO genes (all sets)", yaxis=list(range = c(0,101)))
p
sing <- csv %>% filter(Category=="Single-Copy")
...
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "Duplicated BUSCO genes (all sets)", yaxis=list(range = c(0,101)))
p
dup <- csv %>% filter(Category=="Duplicated")
...
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "Fragmented BUSCO genes (all sets)", yaxis=list(range = c(0,21)))
p
frag <- csv %>% filter(Category=="Fragmented")
...
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "Missing BUSCO genes (all sets)", yaxis=list(range = c(0,21)))
p
mis <- csv %>% filter(Category=="Missing")
...
sampTra1<- sampTra %>% filter(Kmer=="KmerA")
sampTra2<- sampTra %>% filter(Kmer=="KmerB")
sampTra3<- sampTra %>% filter(Kmer=="KmerC")

p <- plot_ly(sampTra1, x=~Category, y=~Score, type="box", boxmean='sd', name="Kmer set A", fillcolor='rgba(118, 176, 212,.4)', 
             marker=list(color='rgba(118, 176, 212,.4)'), line=list(color='rgba(118, 176, 212,1)'))
p <- p %>% add_trace(y=sampTra2$Score, name="Kmer set B", fillcolor='rgba(22, 84, 138,.4)', marker=list(color='rgba(22, 84, 138,.4)'), 
                     line=list(color='rgba(22, 84, 138,.65)'))
p <- p %>% add_trace(y=sampTra3$Score, name="Kmer set C", fillcolor='rgba(3, 43, 76,.4)', marker=list(color='rgba(3, 43, 76,.4)'), 
                     line=list(color='rgba(3, 43, 76,.65)'))
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "CE BUSCO genes (kmer test, 150bp)", 
                  xaxis =list(categoryorder = "array", 
                  categoryarray = c("Complete", "Single-Copy", "Duplicated","Fragmented","Missing")),
...
p <- p %>% add_trace(y=sampTra3$Score, name="Kmer set C", fillcolor='rgba(3, 43, 76,.4)', marker=list(color='rgba(3, 43, 76,.4)'), 
                     line=list(color='rgba(3, 43, 76,.65)'))
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "DM BUSCO genes (kmer test, 150bp)", 
                  xaxis =list(categoryorder = "array", 
                  categoryarray = c("Complete", "Single-Copy", "Duplicated","Fragmented","Missing")),
...
p <- p %>% add_trace(y=sampTra3$Score, name="Kmer set C", fillcolor='rgba(3, 43, 76,.4)', marker=list(color='rgba(3, 43, 76,.4)'), 
                     line=list(color='rgba(3, 43, 76,.65)'))
p <- p %>% layout(boxmode = "group", legend = list(y=.5), title = "MM BUSCO genes (kmer test, 150bp)", 
                  xaxis =list(categoryorder = "array", 
                  categoryarray = c("Complete", "Single-Copy", "Duplicated","Fragmented","Missing")),
                  yaxis=list(title="BUSCO %", type = "linear", range=c(0,101), dtick=10))
p
